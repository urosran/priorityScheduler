...
public abstract class Tunnel {
    ...
    public final boolean tryToEnter(Vehicle vehicle) throws InterruptedException {
     ...
     */
    public abstract boolean tryToEnterInner(Vehicle vehicle) throws InterruptedException;
